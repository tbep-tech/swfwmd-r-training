...
This is a list of the data sources used in this training.

 - Full Dataset as a [zipped folder](data/data.zip). Inside you'll find these files:
    - Training data: [dat.csv](data/dat.csv)
    - Station locations: [statloc.csv](data/statloc.csv)
    - Spatial boundary shapefile:
         - [bounds.dbf](data/bounds.dbf)
         - [bounds.prj](data/bounds.prj)
         - [bounds.shp](data/bounds.shp)
         - [bounds.shx](data/bounds.shx)
