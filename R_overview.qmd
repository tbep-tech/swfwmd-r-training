...
One goal for this workshop is to use examples that look more like real SWFWMD work. A useful way to do that is to access data from the SWFWMD [Environmetnal Data Portal](https://www.swfwmd.state.fl.us/resources/data-maps/environmental-data-portal){target="_blank"} and then use those data in later wrangling, plotting, and spatial examples.
