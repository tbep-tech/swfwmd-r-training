...
[![](figs/swfwmd_logo.png){width=250px fig-align="center"}](https://www.swfwmd.state.fl.us/){target="_blank"}
...
knitr::kable(agenda, row.names = F, format = 'markdown')
```
...
1. Finally, please make sure to download the required datasets [here](data/data.zip) and make sure you have the `here`, `tidyverse`, `sf`, `mapview`, and `ggspatial` packages installed. See the [setup instructions](setup.html) for details.
