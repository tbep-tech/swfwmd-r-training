...
1. Finally, please make sure to download the required datasets [here](data/data.zip) and make sure you have the `here`, `tidyverse`, `sf`, and `mapview` packages installed. See the [setup instructions](setup.html) for details.
