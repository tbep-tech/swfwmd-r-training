...
1. We have a live coding link that we'll be using as we go through the lessons, accessible [here](https://tinyurl.com/swfwmd-r-training-live-coding){target="_blank"}. If you get lost, you can copy/paste code from this link into RStudio.
